defmodule MyStoreWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MyStoreWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MyStoreWeb.Gettext, "errors", msg, opts)
    end
  end
